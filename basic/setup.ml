...
(* OASIS_START *)
(* DO NOT EDIT (digest: e3bd7e5f1a8f4a1c1f226e1572821306) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Mirage skeleton application";
          description = None;
          categories = [];
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("./gen_xen.sh", ["hello"])))];
               };
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\"\243\005\140\152-\143$\210\031\134\214\015\156\159\212";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
