...
(* OASIS_START *)
(* DO NOT EDIT (digest: 95ffd6e5c064b65661322d2d5e1f7877) *)
(*
...
let setup_t =
  {
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("./gen_crunch.sh", [])))];
               };
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\222\133\235\226\241\173i\198\193:\020\240\025\139\246\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
