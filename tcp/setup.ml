...
(* OASIS_START *)
(* DO NOT EDIT (digest: a84364a7b0b958def07e9e3088c08298) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "iperf_self.ml"; });
               Executable
                 ({
                     cs_name = "iperf_self.nobj.o";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\192\138?\221\170]8\1811|?\253ao\004\154";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
