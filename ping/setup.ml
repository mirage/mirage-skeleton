...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75254114acfedacbfec7c11696a31e12) *)
(*
...
let setup_t =
  {
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("./gen_xen.sh", ["ping"])))];
               };
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\234\136v\157o\164\235\137\148@\016\t\223`\249\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
